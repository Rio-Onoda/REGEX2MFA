...
public class AST extends PCREBaseVisitor<RegexNode> {
    ...
    @Override
    public RegexNode visitDigit(PCREParser.DigitContext ctx) {
        return new CharNode(ctx.getText());
    }

    @Override
    public RegexNode visitOther(PCREParser.OtherContext ctx) {
        return new CharNode(ctx.getText());
    }
